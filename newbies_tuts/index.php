...
<tr><td width="50%">
		<?php
		echo "<br>----------------------------------------------------------------------------------<br>";
		echo "Viewing table from your Database";
		...
		echo "<table border='1' style='border-collapse:collapse;background-color:yellow; color:#000000;'>
				<th>Student ID</th>
				<th>Last Name</th>
				<th>First Name</th>
	...
	$query1 = mysqli_query($con, "SELECT * FROM tbl_students ") or die(mysqli_error());
		while($row = mysqli_fetch_array($query1)){
			echo "<tr>
					...
					<td>$row[yearlevel]<br>
					<td>$row[status]</td>
					<td align='center'><a style='text-decoration:yes;color:#FF0000;' href='delete.php/?id=$row[studID]'>X</a></td>
				  </tr>";
		}
		echo "</table><br><br>"
	?>
		<br>----------------------------------------------------------------------------------<br>
		Updating Values by <b>Copy and Paste the Student Number inside the table</b> 
		<form action="update.php" method="POST">
	
		<table>
		<tr>
			<td><input type ="text" name="studID" placeholder="Enter Student ID to Update"></td>
			<td><input type ="text" name="firstName" placeholder="Update First Name"></td>
			<td><input type ="text" name="lastName" placeholder="Update Last Name"></td>
			</tr><tr>
			<td><input type ="text" name="MI" placeholder="Update Middle Initial"></td>
			<td><input type ="text" name="course" placeholder="Update Course"></td>
			<td><input type ="text" name="yearlevel" placeholder="Update Year Level"></td>``
			</tr><tr>
			<td colspan="4">
	...
	<table align="justified" style="padding-top:30px;">
				...
				<table>
					...
					<?php
						...
						while($row = mysqli_fetch_array($query2)){
							echo "<td style='color:#000000;background-color:#FFFFFF;height:198px;width:150px;'>
